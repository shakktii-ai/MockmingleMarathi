          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-24">
            ...
            <div className="bg-gradient-to-br from-green-50 to-teal-50 p-8 rounded-2xl shadow-lg">
              <div className="flex flex-col items-center md:items-start gap-6">
                ...
                <p className="text-gray-600">
                  तुमच्या स्ट्रीम, डिपार्टमेंट, आणि विषयासाठी खास तयार केलेल्या शैक्षणिक टेस्ट्स द्या. तत्काळ AI-आधारित मूल्यांकन आणि सविस्तर फीडबॅक मिळवा, ज्यामुळे तुमची शैक्षणिक कार्यक्षमता सुधारेल.
                </p>
                <ul className="space-y-2">
