        ...
        <div className="bg-black min-h-screen px-4 py-10">
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-32">
            ...
            <div className="bg-white w-[300px] max-w-md rounded-2xl p-5">
              <h2 className="text-2xl font-bold text-center mb-4">विद्यार्थी चाचणी</h2>
              ...
              <p className="text-left my-4 text-sm">
                विद्यार्थी आणि शैक्षणिक वातावरणासाठी डिझाइन केलेले. शैक्षणिक क्षमता, शिकण्याची शैली, टीमवर्क आणि नेतृत्व गुणांचे मूल्यांकन करते.
              </p>

              <div className="flex items-center">
                <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />              </svg><p className="text-left">कामाच्या ठिकाणचे डायनॅमिक्स</p>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />              </svg><p className="text-left">व्यावसायिक नैतिकता</p>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />              </svg><p className="text-left">व्यवस्थापन क्षमता</p>
              </div>
            ...
            {/* Employee Test Card */}
            <div className="bg-white w-[300px] max-w-md rounded-2xl p-5">
              <h2 className="text-2xl font-bold text-center mb-4">कर्मचारी चाचणी</h2>
              ...
              <p className="text-left my-4 text-sm">
                काम करणाऱ्या व्यावसायिकांसाठी तयार केलेले. कामाच्या ठिकाणच्या क्षमता, संघर्ष निवारण, नेतृत्व क्षमता आणि व्यावसायिक निर्णय घेण्याचे मूल्यमापन करते.
              </p>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-xl">
            {generating ? 'तुमची मानसशास्त्रीय चाचणी तयार केली जात आहे...' : 'लोड होत आहे...'}
          </p>
        </div>
        <ToastContainer />
      </div>
  ...
  if (evaluating) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        ...
        <div className="text-center">
          <div className="animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-blue-500 mx-auto"></div>
          <p className="mt-4 text-xl">AI द्वारे तुमच्या प्रतिसादांचे मूल्यांकन केले जात आहे...</p>
          <p className="mt-2 text-gray-600">यासाठी एक मिनिट लागू शकतो. आम्ही तुमच्या निर्णय घेण्याच्या शैलीचे विश्लेषण करत आहोत.</p>
        </div>
        <ToastContainer />
      </div>
    );
    ...
    if (profileType === 'student') {
      ...
      if (evaluation.academicCollaboration) {
        competencyAreas.push({
          name: 'शैक्षणिक सहकार्य',
          score: evaluation.academicCollaboration.score || 2,
          comments: evaluation.academicCollaboration.comments || 'कोणतीही टिप्पणी उपलब्ध नाही'
        });
      }

      if (evaluation.learningEthics) {
        competencyAreas.push({
          name: 'शिकण्याची नैतिकता',
          score: evaluation.learningEthics.score || 2,
          comments: evaluation.learningEthics.comments || 'कोणतीही टिप्पणी उपलब्ध नाही'
        });
      }

      if (evaluation.educationalLeadership) {
        competencyAreas.push({
          name: 'शैक्षणिक नेतृत्व',
          score: evaluation.educationalLeadership.score || 2,
          comments: evaluation.educationalLeadership.comments || 'कोणतीही टिप्पणी उपलब्ध नाही'
        });
      }

      if (evaluation.studyGroupDynamics) {
        competencyAreas.push({
          name: 'अभ्यास गट गतिशीलता',
          score: evaluation.studyGroupDynamics.score || 2,
          comments: evaluation.studyGroupDynamics.comments || 'कोणतीही टिप्पणी उपलब्ध नाही'
        });
      }

      if (evaluation.academicConflictResolution) {
        competencyAreas.push({
          name: 'शैक्षणिक संघर्ष निवारण',
          score: evaluation.academicConflictResolution.score || 2,
          comments: evaluation.academicConflictResolution.comments || 'कोणतीही टिप्पणी उपलब्ध नाही'
        });
      }
      ...
      if (evaluation.classroomParticipation) {
        competencyAreas.push({
          ...
          comments: evaluation.classroomParticipation.comments || 'कोणतीही टिप्पणी उपलब्ध नाही'
        });
      }

      recommendations.push(
        {
          title: 'शिफारस केलेल्या शिकण्याच्या शैली',
          items: evaluation.recommendedLearningStyles || ['व्हिज्युअल लर्निंग', 'प्रॅक्टिकल ॲप्लिकेशन', 'ग्रुप स्टडी']
        },
        {
          title: 'शैक्षणिक मार्ग शिफारसी',
          items: evaluation.academicPathRecommendations || ['पीअर ट्युटरिंगचा विचार करा', 'अभ्यास गटात सामील व्हा', 'हँड्स-ऑन लर्निंगच्या संधी शोधा']
        }
      );
    } else {
      ...
      if (evaluation.empathy) {
        competencyAreas.push({
          ...
          comments: evaluation.empathy.comments || 'कोणतीही टिप्पणी उपलब्ध नाही'
        });
      }
      ...
      if (evaluation.assertiveness) {
        competencyAreas.push({
          ...
          comments: evaluation.assertiveness.comments || 'कोणतीही टिप्पणी उपलब्ध नाही'
        });
      }
      ...
      if (evaluation.ethicalReasoning) {
        competencyAreas.push({
          ...
          comments: evaluation.ethicalReasoning.comments || 'कोणतीही टिप्पणी उपलब्ध नाही'
        });
      }
      ...
      if (evaluation.collaboration) {
        competencyAreas.push({
          ...
          comments: evaluation.collaboration.comments || 'कोणतीही टिप्पणी उपलब्ध नाही'
        });
      }
      ...
      if (evaluation.conflictResolution) {
        competencyAreas.push({
          ...
          comments: evaluation.conflictResolution.comments || 'कोणतीही टिप्पणी उपलब्ध नाही'
        });
      }
      ...
      if (evaluation.leadershipPotential) {
        competencyAreas.push({
          ...
          comments: evaluation.leadershipPotential.comments || 'कोणतीही टिप्पणी उपलब्ध नाही'
        });
      }

      recommendations.push(
        {
          title: 'करिअर मार्ग शिफारसी',
          items: evaluation.careerPathRecommendations || ['प्रोजेक्ट मॅनेजमेंट', 'टीम लीडरशिप', 'स्पेशलाइज्ड टेक्निकल रोल']
        },
        {
          title: 'भूमिका योग्यतेच्या शिफारसी',
          items: evaluation.roleFitRecommendations || ['टीम लीड', 'प्रोजेक्ट कोऑर्डिनेटर', 'टेक्निकल स्पेशालिस्ट']
        }
      );
    }
      ...
      <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-4">
            <h1 className="text-2xl font-bold text-white">तुमचे मानसशास्त्रीय मूल्यांकन निकाल</h1>
          </div>

          <div className="p-6">
            <div className="mb-8">
              <h2 className="text-xl font-semibold mb-4">एकूण मूल्यांकन</h2>
