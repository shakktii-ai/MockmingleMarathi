  ...
  return (
    ...
    >
      ...
      <Link href={link}>
        ...
        {progress !== undefined && (
          <div className="flex items-center gap-2">
            <span className="text-xs font-medium text-muted-foreground">{progress}% पूर्ण</span>
          </div>
        )}
      </Link>
      ...
      <div className="absolute bottom-6 right-6 opacity-0 translate-y-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
        <span className="text-xs font-medium text-primary">AI-मार्गदर्शित फीडबॅक →</span>
      </div>
    </div>
  );
}
