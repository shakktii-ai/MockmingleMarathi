...
- Write the report in **Marathi** language using Devanagari script.
- Use fluent, grammatically correct and professional Marathi.
- Ensure the tone is formal, insightful, and personalized.
...
Please return the result as a valid JSON object with the following structure and exact property names:

{
  "personalityType": "Short Marathi title for the personality type (e.g., 'दृढनिश्चयी विचारवंत')",
  "executiveSummary": "Detailed executive summary in formal, professional Marathi using Devanagari script",
  "strengths": [
    {
      "title": "Marathi title of the strength",
      "description": "Short description in Marathi explaining how this strength is reflected"
    }
  ],
  "areasForGrowth": [
    {
      "title": "Marathi title of the area to improve",
      "description": "Short explanation in Marathi of this improvement area"
    }
  ],
  "careerMatches": [
    {
      "title": "Suggested career name in Marathi or English",
      "description": "Short Marathi explanation of why this career fits"
    }
  ],
  "recommendations": [
    {
      "title": "Marathi title of the recommendation",
      "description": "Short but practical Marathi advice with actionable steps"
    }
  ],
  "reportId": "A unique identifier string (e.g., 'report-202506131001')"
}

IMPORTANT:
- Output should be a JSON object only — no text, markdown, or formatting outside the JSON.
- All text should be in grammatically correct, fluent Marathi using Devanagari script.
- Avoid overly generic advice. Use formal but warm tone, like a professional psychologist would.
