...
async function handler(req, res) {
  ...
  try {
    ...
    // Just use userId from query or default to demo user
    let userId = req.query.userId || '6462d8fbf6c3e30000000001';
    ...
    */
    ...
    return res.status(500).json({ error: 'Server error retrieving progress data' });
  }
}
