...
function DecisionScenario() {
  ...
  const welcomeMessage = `तुमच्या वैयक्तिक निर्णय घेण्याच्या प्रवासात तुमचे स्वागत आहे! प्रत्येक स्तरावर, तुम्हाला तुमच्या विचारांना, निर्णयांना आणि नेतृत्वाला आव्हान देणाऱ्या वास्तविक जीवनातील प्रसंगांचा सामना करावा लागेल. साध्या दैनंदिन निवडींपासून ते गुंतागुंतीच्या, उच्च-जोखीम असलेल्या समस्यांपर्यंत, तुम्ही घेतलेला प्रत्येक निर्णय तुमचा मार्ग ठरवेल आणि सखोल आव्हानांसह उच्च स्तर अनलॉक करेल. जसे तुम्ही प्रगती कराल, तशी तुमची प्राधान्य देण्याची, दबाव हाताळण्याची आणि तर्कशुद्ध विचार करण्याची क्षमता वाढेल. विचारपूर्वक निवडा—प्रत्येक स्तर तुम्हाला स्मार्ट निर्णय घेण्याच्या कलेत पारंगत होण्याच्या एक पाऊल जवळ नेईल.`;
  ...
  const startPractice = async () => {
    ...
    try {
      ...
      if (isLocked) {
        ...
        setErrorMessage(`स्तर ${selectedLevel} लॉक आहे. कृपया आधीचा स्तर पूर्ण करा.`);
        setShowError(true);
      ...
      const message = error.toString().includes('API key') ?
        'OpenAI API की गहाळ आहे. कृपया तुमच्या एन्व्हायर्नमेंट व्हेरिएबल्समध्ये तुमची API की जोडा.' :
        'API कडून प्रसंग लोड करण्यात अयशस्वी. कृपया नंतर पुन्हा प्रयत्न करा किंवा सपोर्टशी संपर्क साधा.';
  ...
  const submitResponse = async () => {
    ...
    try {
      ...
      // Show error to user
      setErrorMessage('तुमची प्रतिक्रिया सबमिट करताना एरर आली. कृपया पुन्हा प्रयत्न करा.');
      setShowError(true);
    } finally {
      setLoading(false);
    }
  ...
  const evaluateResponses = async () => {
    try {
      ...
      setErrorMessage(error.message || 'प्रतिक्रियांचे मूल्यमापन करण्यात अयशस्वी. कृपया पुन्हा प्रयत्न करा.');
      setShowError(true);
  ...
  const renderWelcome = () => {
    return (
      <div className="text-center max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">निर्णय घेण्याचा सराव</h1>
    ...
    if (!currentScenario) {
      return (
        <div className="text-center p-8">
          <p>कोणताही प्रसंग सापडला नाही. कृपया पुन्हा प्रयत्न करा.</p>
          <button
      ...
      <div className="max-w-3xl mx-auto p-6 bg-white rounded-xl shadow-md">
        <div className="flex items-center mb-6">
          ...
          <span className="text-gray-600 font-medium">
            प्रश्न {currentIndex + 1} पैकी {scenarios.length}
          </span>
        </div>
        ...
        <div className="space-y-4 mb-8">
          {currentScenario.options.map((option) => (
            <div
              key={option.id}
              className={`p-4 border-2 rounded-lg cursor-pointer transition-all duration-200 ${selectedOption === option.id
            ...
            >
              <div className="flex items-start">
                <span className={`inline-flex items-center justify-center w-6 h-6 rounded-full mr-3 mt-0.5 flex-shrink-0 ${selectedOption === option.id
        ...
        <div className="flex justify-between items-center">
          <div className="text-gray-600">
            वेळ शिल्लक: <span className="font-medium">{Math.floor(timeLeft / 60)}:{(timeLeft % 60).toString().padStart(2, '0')}</span>
          </div>
          <button
            className={`px-6 py-2 rounded-lg text-white font-medium ${selectedOption
          ...
          >
            {currentIndex < scenarios.length - 1 ? 'पुढील' : 'सबमिट करा'}
          </button>
        </div>
      </div>
    );
  ...
  const renderLevelSelection = () => {
    return (
      <div className="p-6 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold mb-6 text-center">स्तर निवडा</h2>
        ...
        <div className="flex justify-center mb-6">
          {['Beginner', 'Moderate', 'Expert'].map((diff) => (
            <button
              key={diff}
              className={`px-4 py-2 mx-2 rounded-lg ${difficulty === diff
                ? 'bg-blue-600 text-white'
                : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                }`}
              onClick={() => setDifficulty(diff)}
            >
              {diff === 'Beginner' ? 'प्रारंभिक' : diff === 'Moderate' ? 'मध्यम' : 'तज्ञ'}
            </button>
          ))}
        </div>
          ...
          {levelProgress[difficulty]?.map((level) => {
            ...
            return (
              <div
                ...
                className={`relative p-4 rounded-lg text-center transition-all ${isLocked
              ...
              >
                <div className="text-xl font-bold mb-1">स्तर {level.level}</div>
        ...
        <div className="mt-8 text-center">
          <button
            className={`px-6 py-3 rounded-lg text-white font-medium text-lg ${selectedLevel && !(levelProgress[difficulty]?.[selectedLevel - 1]?.locked && selectedLevel > 1)
          ...
          >
            {selectedLevel ? `स्तर ${selectedLevel} सुरू करा` : 'स्तर निवडा'}
          </button>

          {/* Level Requirements */}
          {selectedLevel && levelProgress[difficulty]?.[selectedLevel - 1]?.locked && selectedLevel > 1 && (
            <p className="mt-2 text-sm text-red-500">
              स्तर {selectedLevel - 1} पूर्ण करा अनलॉक करण्यासाठी
            </p>
          )}
        </div>
      </div>
  ...
  const renderEvaluation = () => {
    ...
    const feedback = evaluationData.feedback || 'कोणताही फीडबॅक उपलब्ध नाही.';
    const strengths = Array.isArray(evaluationData.strengths)
      ? evaluationData.strengths
      : (evaluationData.strengths ? [evaluationData.strengths] : ['कोणतीही विशिष्ट ताकद ओळखली गेली नाही.']);
    const improvements = Array.isArray(evaluationData.improvements)
      ? evaluationData.improvements
      : (evaluationData.improvements ? [evaluationData.improvements] : ['सुधारणेसाठी कोणतीही विशिष्ट क्षेत्रे नाहीत.']);

    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-green-100 rounded-lg p-6 mb-6 text-center text-green-800 shadow-md">
          <h2 className="text-2xl font-bold mb-2">स्तर {selectedLevel} पूर्ण झाला! ({difficulty === 'Beginner' ? 'प्रारंभिक' : difficulty === 'Moderate' ? 'मध्यम' : 'तज्ञ'})</h2>
          ...
          <div className="flex justify-center gap-8 my-4">
            <div className="flex flex-col items-center">
              ...
              <div className="text-xs text-gray-500">एकूण स्कोअर</div>
            </div>
            <div className="flex flex-col items-center">
              <div className="text-xl font-bold text-blue-700">{decisionQuality}</div>
              <div className="text-xs text-gray-500">निर्णयाची गुणवत्ता</div>
            </div>
            <div className="flex flex-col items-center">
              <div className="text-xl font-bold text-blue-700">{decisionStyle}</div>
              <div className="text-xs text-gray-500">निर्णयाची शैली</div>
            </div>
          </div>

          <div className="mt-4 text-lg font-semibold text-indigo-700 animate-pulse">
            {selectedLevel < 10 ? `स्तर ${selectedLevel + 1} आता अनलॉक झाला आहे!` :
              difficulty !== 'Expert' ? `${difficulty === 'Beginner' ? 'मध्यम' : 'तज्ञ'} स्तर आता उपलब्ध आहेत!` :
                "अभिनंदन! तुम्ही सर्व स्तर पूर्ण केले आहेत!"}
          </div>
        </div>

        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h3 className="text-lg font-semibold text-blue-800 mb-2">तुमची निर्णय घेण्याची कामगिरी</h3>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h3 className="text-lg font-semibold text-blue-800 mb-2">स्ट्रेंथ्स (ताकद)</h3>
          <div className="text-gray-700 mb-2">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h3 className="text-lg font-semibold text-blue-800 mb-2">इम्प्रूव्हमेंट एरियाज (सुधारणेची क्षेत्रे)</h3>
          <div className="text-gray-700 mb-2">
            <ul className="list-disc pl-5 space-y-1">
        ...
        {evaluationResult.evaluation?.optionAnalysis && (
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            <h3 className="text-lg font-semibold text-blue-800 mb-4">एकूण निर्णय विश्लेषण</h3>

            {evaluationResult.evaluation.optionAnalysis.trends && (
              <div className="mb-6">
                <h4 className="font-medium text-gray-800 mb-2">निर्णयाचे स्वरूप (Patterns)</h4>
            ...
            {evaluationResult.evaluation.optionAnalysis.habits && (
              <div className="mb-6">
                <h4 className="font-medium text-gray-800 mb-2">तुमच्या निर्णयाच्या सवयी</h4>
            ...
            {evaluationResult.evaluation.optionAnalysis.ethicalDilemmas && (
              <div className="mb-4">
                <h4 className="font-medium text-gray-800 mb-2">नैतिक निर्णय घेणे (Ethical Decision Making)</h4>
        ...
        {evaluationResult.evaluation?.questionAnalysis && evaluationResult.evaluation.questionAnalysis.length > 0 && (
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            <h3 className="text-2xl font-bold text-blue-800 mb-6 pb-2 border-b border-gray-200">तपशीलवार प्रश्न विश्लेषण (Detailed Question Analysis)</h3>
                ...
                <div key={`question-${index}`} className="bg-gray-50 rounded-lg overflow-hidden shadow-sm">
                  <div className="bg-indigo-50 px-6 py-4 border-b border-indigo-100">
                    <h4 className="text-lg font-semibold text-indigo-800">
                      {question.questionTitle || `प्रश्न ${index + 1}`}
                    </h4>
                  </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-r-lg">
                        ...
                        <div className="mt-3 pt-3 border-t border-yellow-100">
                          <h6 className="text-sm font-medium text-yellow-700 mb-1">गुणवत्ता मूल्यांकन (Quality Assessment)</h6>
                      ...
                      <div className="bg-blue-50 border-l-4 border-blue-400 p-5 rounded-r-lg">
                        <h5 className="font-medium text-blue-800 mb-2 flex items-center">
                          ...
                          पर्यायी परिणाम (Alternative Outcomes)
                        </h5>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 md:py-10 bg-gray-50 min-h-screen">
      <Head>
        <title>निर्णय घेण्याचा सराव - SHAKKTII AI</title>
        <meta name="description" content="तुमच्या निर्णय घेण्याच्या कौशल्यांचा सराव करा" />
      </Head>
