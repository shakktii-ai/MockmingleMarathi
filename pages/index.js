...
export default function dashboard({ Logout, user }) {
  ...
  return (
    <>
      ...
      <div
        className="min-h-screen bg-gradient-to-b text-white bg-cover flex flex-col items-center justify-center"
        style={{ backgroundImage: "url('/bg.gif')" }}
      >
        {/* Navigation Bar */}
       <nav className="fixed top-0 left-0 z-50 flex justify-between items-center py-4 px-6 backdrop-blur-md bg-black/40 w-full shadow-lg">
   <div className="flex items-center gap-2">
            {/* <img src="/Logo.png" alt="लोगो चिन्ह " className="w-8 h-8 object-contain" /> */}
            <div className="text-white text-xl font-bold">Mock<span className="text-pink-500">Mingle</span></div>
          </div>
