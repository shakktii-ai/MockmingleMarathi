...
function AcademicTest() {
  ...
  useEffect(() => {
    ...
    switch (stream) {
      case 'विज्ञान':
        options = ['भौतिकशास्त्र', 'रसायनशास्त्र', 'जीवशास्त्र', 'गणित'];
        break;
      case 'वाणिज्य':
        options = ['अकाउंटिंग', 'बिझनेस स्टडीज', 'अर्थशास्त्र', 'सांख्यिकी'];
        break;
      case 'कला/मानव्यशास्त्र':
        options = ['इतिहास', 'भूगोल', 'राज्यशास्त्र', 'समाजशास्त्र', 'मानसशास्त्र', 'साहित्य'];
        break;
      case 'अभियांत्रिकी':
        options = ['कॉम्प्युटर सायन्स', 'मेकॅनिकल', 'सिव्हिल', 'इलेक्ट्रिकल', 'इलेक्ट्रॉनिक्स'];
        break;
      case 'वैद्यकीय':
        options = ['ॲनाटॉमी', 'फिजिओलॉजी', 'बायोकेमिस्ट्री', 'मायक्रोबायोलॉजी', 'फार्मकोलॉजी'];
        break;
      case 'कायदा':
        options = ['घटनात्मक कायदा', 'फौजदारी कायदा', 'दिवाणी कायदा', 'कॉर्पोरेट कायदा', 'आंतरराष्ट्रीय कायदा'];
        break;
      case 'सामान्य':
      case '१० वी':
      case '११ वी':
      case '१२ वी':
        options = ['गणित', 'विज्ञान', 'समाजशास्त्र', 'भाषा', 'संगणक'];
        break;
      default:
        options = ['सामान्य ज्ञान'];
    }
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800">शैक्षणिक चाचणी</h1>
          <button
        ...
        <h2 className="text-2xl font-semibold text-gray-800">🧭 चरण १: तुमचा शैक्षणिक प्रवाह निवडा</h2>
        <p className="text-gray-600">कृपया खालील सूचीमधून तुमचा शैक्षणिक प्रवाह निवडा:</p>
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-2xl font-semibold text-gray-800">🏫 चरण २: तुमचा विभाग किंवा विशेषीकरण निवडा</h2>
        </div>

        <p className="text-gray-600">तुम्ही <span className="font-semibold text-blue-600">{stream}</span> निवडले आहे. आता तुमचा विभाग निवडा:</p>
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-2xl font-semibold text-gray-800">📚 चरण ३: विशिष्ट विषय निवडा</h2>
        </div>

        <p className="text-gray-600">तुम्ही <span className="font-semibold text-blue-600">{stream} - {department}</span> निवडले आहे. आता एक विशिष्ट विषय निवडा:</p>
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-2xl font-semibold text-gray-800">📈 चरण ४: आत्मविश्वास तपासा</h2>
        </div>

        <p className="text-gray-600">१ ते ५ च्या स्केलवर, तुम्हाला <span className="font-semibold text-blue-600">{subject}</span> मध्ये किती आत्मविश्वास आहे?</p>
        <p className="text-gray-500">(१ = आत्मविश्वास नाही, ५ = खूप आत्मविश्वास)</p>
  ...
  const renderFormatSelection = () => {
    ...
    const descriptions = {
      'MCQ': 'बहुपर्यायी प्रश्न',
      'Written': 'लघू उत्तर',
      'Speaking': 'तोंडी उत्तरे'
    };
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-2xl font-semibold text-gray-800">📝 चरण ५: चाचणी स्वरूप निवडा</h2>
        </div>

        <p className="text-gray-600">तुमचे पसंतीचे चाचणी स्वरूप निवडा:</p>
        ...
        {testFormat && (
          <div className="mt-8 flex justify-center">
            ...
            >
              {loading ? 'चाचणी तयार केली जात आहे...' : 'तुमची चाचणी सुरू करा'}
            </button>
          </div>
        )}
      </div>
    ...
    return (
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-semibold text-gray-800">प्रश्न {currentQuestion + 1} पैकी {test.questions.length}</h2>
          <div className="flex items-center space-x-3">
            <div className="text-gray-600">वेळ: {formatTime(timeSpent)}</div>
