...
export default async function handler(req, res) {
  ...
  try {
    ...
    const prompt = [
      ...
      // `- Each sentence must feel like it was originally written in Marathi — not translated from English.`,
      // `- Avoid literal or robotic translation. Maintain a Marathi-first tone suitable for a psychometric test.`,
      '- Each statement must reflect a **specific psychological trait**, such as:',
      ...
      JSON.stringify([
        {
          text: "मला सामाजिक संमेलने आणि नवीन लोकांशी भेटायला आवडते.",
          options: [
