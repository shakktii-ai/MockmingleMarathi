...
export default function PsychometricTestHistory() {
  ...
  const fetchTestHistory = async (userId, email) => {
    try {
      ...
      if (response.data && response.data.success && response.data.history) {
        ...
        setTests([]);
        toast.info('कोणताही चाचणी इतिहास आढळला नाही');
      }
    } catch (error) {
      console.error('Error fetching test history:', error);
      toast.error('चाचणी इतिहास लोड करण्यात त्रुटी आली. कृपया नंतर पुन्हा प्रयत्न करा.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const prepareRadarChartData = (results) => {
    ...
    if (isStudentProfile) {
      ...
      const studentCompetencies = [
        { key: 'academicCollaboration', label: 'शैक्षणिक सहयोग (Academic Collaboration)' },
        { key: 'learningEthics', label: 'शिकण्याची नैतिकता (Learning Ethics)' },
        { key: 'educationalLeadership', label: 'शैक्षणिक नेतृत्व (Educational Leadership)' },
        { key: 'studyGroupDynamics', label: 'अभ्यास गट गतिशीलता (Study Group Dynamics)' },
        { key: 'academicConflictResolution', label: 'शैक्षणिक संघर्ष निवारण (Academic Conflict Resolution)' },
        { key: 'classroomParticipation', label: 'वर्गातील सहभाग (Classroom Participation)' }
      ];
      ...
      const employeeCompetencies = [
        { key: 'empathy', label: 'सहानुभूती (Empathy)' },
        { key: 'assertiveness', label: 'निश्चय (Assertiveness)' },
        { key: 'ethicalReasoning', label: 'नैतिक तर्क (Ethical Reasoning)' },
        { key: 'collaboration', label: 'सहयोग (Collaboration)' },
        { key: 'conflictResolution', label: 'संघर्ष निवारण (Conflict Resolution)' },
        { key: 'leadershipPotential', label: 'नेतृत्व क्षमता (Leadership Potential)' },
        { key: 'strategicThinking', label: 'धोरणात्मक विचार (Strategic Thinking)' },
        { key: 'adaptability', label: 'अनुकूलनक्षमता (Adaptability)' }
      ];
    ...
    if (labels.length === 0) {
      labels = ['कम्युनिकेशन', 'सांघिक कार्य', 'नेतृत्व', 'समस्या निराकरण', 'अनुकूलनक्षमता'];
      data = [2, 2, 2, 2, 2];
    }
          ...
          afterLabel: function (context) {
            ...
            if (context.chart.data.competencyResults && context.chart.data.competencyKeys) {
              ...
              if (competencyData && competencyData.comments) {
                return '\nटिप्पणी: ' + competencyData.comments;
              }
            }
            return '';
          }
    ...
    return (
      <div className="bg-white p-4 rounded-lg border shadow-sm mb-4">
        ...
        <div className="space-y-2">
          {comments && (
            <div>
              <h4 className="text-sm font-medium text-gray-700">मूल्यांकन (Assessment):</h4>
          ...
          {developmentTips && (
            <div>
              <h4 className="text-sm font-medium text-gray-700">विकासासाठी टिप्स:</h4>
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <Head>
          <title>चाचणी इतिहास लोड होत आहे | SHAKKTII AI</title>
        </Head>
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4"></div>
          <p className="mt-4 text-xl">तुमचा चाचणी इतिहास लोड होत आहे...</p>
        </div>
        <ToastContainer />
      </div>
    );
  ...
  const prepareCompetencyAreas = (results) => {
    ...
    const allCompetencies = {
      student: [
        { key: 'academicCollaboration', name: 'शैक्षणिक सहयोग (Academic Collaboration)' },
        { key: 'learningEthics', name: 'शिकण्याची नैतिकता (Learning Ethics)' },
        { key: 'educationalLeadership', name: 'शैक्षणिक नेतृत्व (Educational Leadership)' },
        { key: 'studyGroupDynamics', name: 'अभ्यास गट गतिशीलता (Study Group Dynamics)' },
        { key: 'academicConflictResolution', name: 'शैक्षणिक संघर्ष निवारण (Academic Conflict Resolution)' },
        { key: 'classroomParticipation', name: 'वर्गातील सहभाग (Classroom Participation)' }
      ],
      employee: [
        { key: 'empathy', name: 'सहानुभूती (Empathy)' },
        { key: 'assertiveness', name: 'निश्चय (Assertiveness)' },
        { key: 'ethicalReasoning', name: 'नैतिक तर्क (Ethical Reasoning)' },
        { key: 'collaboration', name: 'सहयोग (Collaboration)' },
        { key: 'conflictResolution', name: 'संघर्ष निवारण (Conflict Resolution)' },
        { key: 'leadershipPotential', name: 'नेतृत्व क्षमता (Leadership Potential)' },
        { key: 'strategicThinking', name: 'धोरणात्मक विचार (Strategic Thinking)' },
        { key: 'adaptability', name: 'अनुकूलनक्षमता (Adaptability)' }
      ]
    };
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <Head>
        <title>सायकोमेट्रिक चाचणी इतिहास | SHAKKTII AI</title>
      </Head>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-4">
                <h1 className="text-xl font-bold text-white">तुमचा चाचणी इतिहास</h1>
              </div>
              ...
              <div className="divide-y">
                {tests.length > 0 ? (
                      ...
                      <div className="flex justify-between items-center">
                        <div>
                          <h2 className="font-medium">
                            {test.profileType === 'student' ? 'विद्यार्थी मूल्यांकन' : 'व्यावसायिक मूल्यांकन'}
                          </h2>
                  ...
                  <div className="p-8 text-center">
                    <p className="text-gray-500 mb-4">तुम्ही अद्याप कोणतीही सायकोमेट्रिक चाचणी घेतलेली नाही.</p>
                    <button
                      onClick={() => router.push('/psychometricTest')}
                      className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
                    >
                      तुमची पहिली चाचणी द्या
                    </button>
                  </div>
                )}
              </div>
          ...
          <div className="lg:w-2/3">
            {selectedTest && selectedTest.response ? (
              <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
                <Head>
                  <title>सायकोमेट्रिक चाचणी निकाल | SHAKKTII AI</title>
                </Head>
                <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
                  <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-4">
                    <h1 className="text-2xl font-bold text-white">तुमचे सायकोमेट्रिक मूल्यांकन निकाल</h1>
                  </div>

                  <div className="p-6">
                    <div className="mb-8">
                      <h2 className="text-xl font-semibold mb-4">एकूण मूल्यांकन (Overall Assessment)</h2>
                      <div className="bg-gray-50 p-4 rounded-lg">
                        <div className="flex items-center justify-between mb-4">
                          <span className="text-lg font-medium">एकूण स्कोअर:</span>
                          <div className="flex items-center">
                        ...
                        <div className="mb-4">
                          <h3 className="font-medium mb-2">विश्लेषण (Analysis)</h3>
                          <p className="text-gray-700">{selectedTest.response?.results?.analysis || ''}</p>
                        </div>

                        <div className="mb-4">
                          <h3 className="font-medium mb-2">निर्णय घेण्याची शैली (Decision-Making Profile)</h3>
                          <div className="grid grid-cols-2 gap-3">
                            <div className="bg-white p-3 rounded border">
                              <div className="text-sm text-gray-500">प्राथमिक शैली (Primary Style)</div>
                              <div className="font-medium">{selectedTest.response?.results?.decisionMakingStyle || ''}</div>
                            </div>
                            <div className="bg-white p-3 rounded border">
                              <div className="text-sm text-gray-500">दुय्यम शैली (Secondary Style)</div>
                        ...
                        <div>
                          <h3 className="font-medium mb-2">मुख्य व्यक्तिमत्व वैशिष्ट्ये (Key Personality Traits)</h3>
                          <div className="flex flex-wrap gap-2">
                            {(selectedTest.response?.results?.keyTraits || []).length > 0 ? (
                              ...
                              <span className="text-gray-500 text-sm">वैशिष्ट्ये उपलब्ध नाहीत</span>
                            )}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="mb-8">
                      <h2 className="text-xl font-semibold mb-4">योग्यता क्षेत्रे (Competency Areas)</h2>
                      <div className="mb-6">
                        <div className="bg-white p-4 rounded-lg border shadow-sm">
                          <h3 className="font-medium mb-3 text-gray-700">योग्यता रडार (Competency Radar)</h3>
                          ...
                          <div className="text-center text-sm text-gray-500">तपशील पाहण्यासाठी संबंधित घटकावर क्लिक करा</div>
                        </div>
                      </div>
                                ...
                                <div className="p-4">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                      {area.developmentTips || `सुधारित प्रशिक्षण आणि सरावाद्वारे ${area.name.toLowerCase()} कौशल्ये विकसित करण्यावर लक्ष केंद्रित करण्याचा विचार करा.`}
                                    </p>
                                  </div>
                                </div>
                              </div>
                    ...
                    <div className="mb-8">
                      <h2 className="text-xl font-semibold mb-4">मुख्य माहिती (Key Insights)</h2>
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className="bg-white rounded-lg border shadow-sm p-5">
                          <div className="flex items-center mb-4">
                            ...
                            <h3 className="font-semibold text-lg">मुख्य बलस्थाने (Core Strengths)</h3>
                          </div>
                          ...
                          <div className="space-y-3">
                            {(selectedTest.response?.results?.strengths || []).length > 0 ? (
                              ...
                              <p className="text-gray-500 text-sm">कोणतीही बलस्थाने आढळली नाहीत</p>
                            )}
                          </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg border shadow-sm p-5">
                          <div className="flex items-center mb-4">
                            ...
                            <h3 className="font-semibold text-lg">सुधारणेची क्षेत्रे (Growth Opportunities)</h3>
                          </div>
                          ...
                          <div className="space-y-3">
                            {(selectedTest.response?.results?.areasToImprove || []).length > 0 ? (
                              ...
                              <p className="text-gray-500 text-sm">सुधारणेसाठी कोणतीही विशिष्ट क्षेत्रे आढळली नाहीत</p>
                            )}
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="mb-8">
                      <h2 className="text-xl font-semibold mb-4">बेंचमार्क तुलना (Benchmark Comparison)</h2>
                      <div className="bg-white rounded-lg border shadow-sm overflow-hidden">
                        <div className="p-5">
                          <p className="text-gray-700 mb-4">{selectedTest.profileType === 'student' ? 'विद्यार्थ्यांसाठी' : 'व्यावसायिकांसाठी'} समान भूमिकांमधील बेंचमार्क्सशी तुमचे निकाल कसे जुळतात ते पहा.</p>
                                ...
                                return (
                                  <div key={index} className="border rounded-lg p-4">
                                    ...
                                    <div className="flex items-center mb-3">
                                      <div className="w-32 text-sm">तुमचा स्कोअर:</div>
                                    ...
                                    <div className="flex items-center">
                                      <div className="w-32 text-sm">बेंचमार्क (Benchmark):</div>
                                      <div className="flex-1">
                                        <div className="w-full bg-gray-200 rounded-full h-2">
                                          <div
                                    ...
                                    <div className="mt-2 text-sm text-gray-600">
                                      तुम्ही तुमच्या समवयस्कांच्या तुलनेत <span className="font-medium">{percentile} व्या</span> पर्सेटाइलमध्ये आहात.
                                    </div>
                                  </div>
                                );
                              });
                          ...
                          <div className="mt-6 bg-blue-50 p-4 rounded-lg border border-blue-100">
                            <h3 className="font-medium text-blue-800 mb-2">एकूण तुलना (Overall Comparison)</h3>
                            <p className="text-sm text-blue-700 mb-3">
                              तुमचा एकूण स्कोअर <span className="font-medium">{selectedTest.response?.results?.overallScore || 7}/10</span> हा तुम्हाला हे मूल्यांकन पूर्ण केलेल्या {selectedTest.profileType === 'student' ? 'विद्यार्थ्यांमध्ये' : 'व्यावसायिकांमध्ये'}
                              <span className="font-medium"> {Math.round(((selectedTest.response?.results?.overallScore || 7) / 10) * 100)} व्या </span>
                              पर्सेटाइलवर ठेवतो.
                            </p>
                    ...
                    <div className="mb-8">
                      <h2 className="text-xl font-semibold mb-6">करिअर मार्ग शिफारसी (Career Path Recommendations)</h2>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                          ...
                          <div className="flex items-center mb-4">
                            ...
                            <div>
                              <h3 className="text-lg font-semibold text-gray-800">
                                {selectedTest.response?.results?.careerSuggestions?.[0]?.title || 'नेतृत्व आणि व्यवस्थापन (Leadership & Management)'}
                              </h3>
                              <p className="text-sm text-blue-600">
                                {selectedTest.response?.results?.careerSuggestions?.[0]?.description || 'ज्या व्यक्तींना टीमचे मार्गदर्शन करण्यात आणि धोरणात्मक निर्णय घेण्यात रस आहे त्यांच्यासाठी आदर्श.'}
                              </p>
                            </div>
                          </div>
                          <div className="mt-4">
                            <h4 className="text-sm font-medium text-gray-700 mb-2">उदाहरणादाखल भूमिका (Example Roles):</h4>
                            <div className="flex flex-wrap gap-2">
                              {(() => {
                                ...
                                if (rolesArr.length === 0) {
                                  return <span className="text-gray-500 text-xs">कोणत्याही भूमिका दिलेल्या नाहीत</span>;
                                }
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100">
                          <div className="flex items-center mb-4">
                            ...
                            <div>
                              <h3 className="text-lg font-semibold text-gray-800">
                                {selectedTest.response?.results?.careerSuggestions?.[1]?.title || 'तज्ज्ञ आणि तांत्रिक (Specialist & Technical)'}
                              </h3>
                              <p className="text-sm text-purple-600">
                                {selectedTest.response?.results?.careerSuggestions?.[1]?.description || 'जे लोक विशिष्ट आणि तपशील-केंद्रित भूमिकांमध्ये उत्कृष्ट कामगिरी करतात त्यांच्यासाठी योग्य.'}
                              </p>
                            </div>
                          </div>
                          <div className="mt-4">
                      ...
                      <div className="bg-white rounded-xl p-6 border border-gray-200">
                        <h3 className="text-lg font-semibold mb-4">शिफारस केलेले कौशल्य विकास (Recommended Skills Development)</h3>
                            ...
                            <div className="space-y-4">
                              {selectedTest.response?.results?.recommendedSkills?.length > 0 ? (
                                selectedTest.response.results.recommendedSkills.map((skill, index) => {
                                  ...
                                  const skillName = typeof skill === 'string' ? skill : (skill?.name || 'अनामित कौशल्य');
                                ...
                                <p className="text-gray-500 text-sm">कोणतीही विशिष्ट कौशल्ये शिफारस केलेली नाहीत</p>
                              )}
                            </div>
                          </>
                        ) : (
                          <p className="text-gray-500 text-sm">कौशल्य विकासाची कोणतीही माहिती उपलब्ध नाही</p>
                        )}

                        <div className="mt-6 pt-4 border-t border-gray-100">
                          <h4 className="font-medium text-gray-800 mb-2">पुढील पावले (Next Steps)</h4>
                          <ul className="space-y-2 text-sm text-gray-600 mb-6">
                            {selectedTest.response?.results?.nextSteps?.length > 0 ? (
                              selectedTest.response.results.nextSteps.map((step, i) => {
                                ...
                                const stepText = typeof step === 'string' ? step : (step?.action || step?.description || 'पुढील पाऊल');
                                return (
                              ...
                              <li className="text-gray-500 text-sm">पुढील कोणतीही विशिष्ट पावले उपलब्ध नाहीत. वरील तुमची बलस्थाने आणि सुधारणेसाठीच्या क्षेत्रांचे पुनरावलोकन करण्याचा विचार करा.</li>
                            )}
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="mt-8 flex justify-center space-x-4">
                      <button
                        onClick={() => {
                          alert('PDF अहवाल तयार करत आहे... हे वैशिष्ट्य तुमच्या निकालांचा सर्वसमावेशक अहवाल डाउनलोड करेल.');
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden h-full flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <h2 className="text-xl font-medium text-gray-600 mb-2">कोणतीही चाचणी निवडलेली नाही</h2>
                  <p className="text-gray-500">
                    {tests.length > 0
                      ? 'निकाल पाहण्यासाठी यादीतून चाचणी निवडा'
                      : 'येथे तुमचे निकाल पाहण्यासाठी सायकोमेट्रिक चाचणी द्या'}
                  </p>
                  {tests.length === 0 && (
                    <button
                      onClick={() => router.push('/psychometricTest')}
